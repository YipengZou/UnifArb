...
if __name__ == "__main__":
    factor_path = "/home/zouyipeng/Workspace/UnifiedArb/metadata/PredictorLSretWide.csv"
    save_folder = "/home/zouyipeng/Workspace/UnifiedArb/results/plots"
    pdf_path = "/home/zouyipeng/Workspace/UnifiedArb/results/US_plot.pdf"
    cols = pd.read_csv(factor_path).columns[1:]
    det_plots, res_plots, res_sample_plots, eval_plots = [], [], [], []
    e = ArbitrageEvaluator()
    for col in tqdm(cols, desc = "Evaluating US..."):
